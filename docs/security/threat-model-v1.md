...
**Residual:** Malicious toolchain that produces identical output for different inputs; cross-machine reproducibility, unproven — no two machines' digests are ever compared. That gap is maintained in [`docs/release/v1-limitations.md`](../release/v1-limitations.md) and is deliberately not restated here.
