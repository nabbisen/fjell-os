# ADR-0008 — Verified Immutable Rootfs
...
Release signature verification uses a development-grade key in-tree (RFC 012). Hardware-rooted trust is v0.3.

## Deferred Work

- Hardware-rooted signing key (v0.3).
- TPM / DICE integration (v0.3).
