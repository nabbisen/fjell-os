...
recorded in `docs/src/releasing/v1-limitations.md` but the architect may view it as a
...
| `docs/src/releasing/v1-limitations.md` | Gate 9 consolidated reference: 6 items with governing records |
...
| `docs/src/releasing/v1-non-goals.md` | Pointer page to `docs/src/releasing/v1-non-goals.md` (was TODO stub) |
...
This RFC is already listed under the v1.0 limitations in `docs/src/releasing/v1-limitations.md`
...
docs/src/releasing/v1-non-goals.md          (replaced stub)
