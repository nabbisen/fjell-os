# Fjell OS — Compact Handoff Bundle (v0.21.1)

This bundle hands off Fjell OS at **v0.21.1**, the v1.0 freeze candidate. It
...
```sh
tar xzf fjell-os-v0.21.1.tar.gz
cd fjell-os-v0.21.1
cargo xtask build
...
- **Version:** v0.21.1 (v1.0 freeze candidate, patch)
