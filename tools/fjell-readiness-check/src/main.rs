...
//!
//! Parses `docs/src/releasing/v1-readiness.md` and fails if any cell contains
...
const MATRIX_PATH: &str = "docs/src/releasing/v1-readiness.md";
...
";
    ...
    fn current_matrix_has_no_open_cells() {
        ...
        let content = match std::fs::read_to_string("docs/src/releasing/v1-readiness.md") {
            Ok(c) => c,
            Err(_) => return,
        };
        let r = check_matrix(&content);
