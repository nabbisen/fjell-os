...
use fjell_syscall::{sys_debug_writeln, sys_exit, sys_ipc_recv, sys_ipc_reply, sys_reboot};
    ...
    loop {
        ...
        match label {
            ...
            l if l == (tags::BOOT_ROLLBACK & 0xFFFF) => {
                ...
                // state set for semantic correctness; reboot follows immediately
                {
