...
impl SystemSnapshot {
    ...
    pub fn new_with_audit(
        ...
        SystemSnapshot {
            id: SnapshotId(id),
            reason,
            digest: SnapshotDigest::with_audit(
                slot,
                store_seq,
                audit_last_seq,
                audit_dropped_count,
...
mod tests {
    ...
    fn continuity_err_on_sequence_regression() {
        ...
        assert!(matches!(
            ...
            Err(EvidenceGapError::SequenceRegression {
...
impl SnapshotEnvelope {
    pub fn new_v2(source_identity_digest: Digest32, issued_tick: u64, nonce: [u8; 16]) -> Self {
        Self {
...
mod v07_tests {
    ...
    fn envelope_push_record_increments_count() {
        let mut env = SnapshotEnvelope::new_v2(Digest32([0u8; 32]), 1000, [0u8; 16]);
...
mod rfc_v072_002_tests {
    ...
    fn v1_default_is_foreign_authoritative() {
        assert_eq!(
            ConflictDomain::V1_DEFAULT,
            ConflictDomain::ForeignAuthoritative
        );
