...
use crate::aead::{AEAD_KEY_LEN, AEAD_NONCE_LEN, AEAD_TAG_LEN, Aead128Gcm, AeadError};
...
use crate::tls_state::{SxtError, TlsHandshakeState, TlsState};
#[allow(unused_imports)] // v0.7: X25519Public used in key-exchange protocol tests
use crate::x25519::{BASE_POINT, X25519Public, X25519Secret, x25519_diffie_hellman};
...
fn x25519_rfc7748_section6_test_vector_2() {
    ...
    let bob_scalar: [u8; 32] = [
        ...
        0xe6, 0x6f, 0x3b, 0xb1, 0x29, 0x26, 0x18, 0xb6, 0xfd, 0x1c, 0x26, 0x8f, 0xb3, 0x2a, 0xb2,
        0xad, 0xa8,
    ];
    ...
    let bob_pub_expected: [u8; 32] = [
        0x78, 0x34, 0xed, 0x39, 0x9c, 0x4c, 0xec, 0xbb, 0xa3, 0x46, 0x61, 0xdb, 0x7b, 0xcb, 0x69,
        0x6d, 0x21, 0x43, 0x2a, 0xdb, 0x76, 0x9d, 0x15, 0xb6, 0xe5, 0x21, 0x13, 0x89, 0xae, 0x54,
        0xd0, 0x55,
    ];
...
mod rfc_v073_002_tests {
    use crate::hkdf::{HKDF_HASH_LEN, HkdfError, hkdf_expand, hkdf_extract};
