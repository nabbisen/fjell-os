...
pub fn cmd_callsite_audit() -> ExitCode {
    ...
    // ── Check 1: LEASE-CALLSITE-001 ────────────────────────────────────────
    {
        ...
        if found {
            eprintln!(
                "  [FAIL] LEASE-CALLSITE-001: `wrapping_add` found in \
    ...
    // ── Check 2: CAP-CALLSITE-001 ──────────────────────────────────────────
    {
        ...
        if !has_subset {
            eprintln!(
                "  [FAIL] CAP-CALLSITE-001: `is_subset_of` not found in \
        ...
        if suspicious {
            eprintln!(
                "  [WARN] CAP-CALLSITE-001: raw `new_rights &` found without \
