...
use crate::schema::{FieldDef, FieldKind, IntentSchema};

// ── Update domain (0x0100..=0x011F) ──────────────────────────────────────────

const SCHEMA_UPDATE_STAGING_STARTED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "candidate_id",
            kind: FieldKind::U32,
...
const SCHEMA_UPDATE_STAGING_ADVANCED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "candidate_id",
            kind: FieldKind::U32,
...
const SCHEMA_UPDATE_STAGING_FAILED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "candidate_id",
            kind: FieldKind::U32,
...
const SCHEMA_UPDATE_STAGING_CONFIRMED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "candidate_id",
            kind: FieldKind::U32,
...
const SCHEMA_UPDATE_ROLLBACK_BLOCKED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "channel_id",
            kind: FieldKind::U32,
...
const SCHEMA_UPDATE_ROLLBACK_TO_PREVIOUS_SLOT: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "previous_slot",
            kind: FieldKind::U8,
...
const SCHEMA_ATTEST_RECORD_SIGNED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "record_id",
            kind: FieldKind::U32,
...
const SCHEMA_ATTEST_RECORD_VERIFY_FAILED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "record_id",
            kind: FieldKind::U32,
...
const SCHEMA_SECURITY_REGISTRY_ENFORCING: IntentSchema = IntentSchema {
    fields: &[FieldDef {
...
const SCHEMA_SECURITY_PROVIDER_FAULTED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "provider_id",
            kind: FieldKind::U32,
...
const SCHEMA_SECURITY_KEYRING_EPOCH_ADVANCED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "purpose",
            kind: FieldKind::U8,
...
const SCHEMA_NET_LINK_UP: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "device_id",
            kind: FieldKind::U32,
...
const SCHEMA_NET_LINK_DOWN: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "device_id",
            kind: FieldKind::U32,
...
const SCHEMA_NET_SXT_CHANNEL_OPENED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "channel_id",
            kind: FieldKind::U32,
        ...
        FieldDef {
            name: "server_name",
            kind: FieldKind::Bytes16,
            required: true,
        },
    ],
};

const SCHEMA_NET_SXT_CHANNEL_CLOSED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "channel_id",
            kind: FieldKind::U32,
...
const SCHEMA_RECOVERY_ENTERED: IntentSchema = IntentSchema {
    fields: &[FieldDef {
        name: "reason_code",
        kind: FieldKind::U16,
        required: true,
...
const SCHEMA_RECOVERY_EXITED: IntentSchema = IntentSchema {
    fields: &[FieldDef {
        name: "outcome_code",
        kind: FieldKind::U16,
        required: true,
...
const SCHEMA_PLATFORM_PROFILES_READY: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "platform_digest",
...
const SCHEMA_HEALTH_TARGET_REACHED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "target_id",
            kind: FieldKind::U32,
...
const SCHEMA_HEALTH_TARGET_FAILED: IntentSchema = IntentSchema {
    fields: &[
        FieldDef {
            name: "target_id",
            kind: FieldKind::U32,
...
pub const CATALOG_V1: &[IntentEntry] = &[
    ...
    IntentEntry {
        tag: 0x0101,
        name: "UPDATE.STAGING_ADVANCED",
        schema: &SCHEMA_UPDATE_STAGING_ADVANCED,
        owner: OWN_UPGRADED,
    },
    IntentEntry {
        tag: 0x0102,
        name: "UPDATE.STAGING_FAILED",
        schema: &SCHEMA_UPDATE_STAGING_FAILED,
        owner: OWN_UPGRADED,
    },
    IntentEntry {
        tag: 0x0103,
        name: "UPDATE.STAGING_CONFIRMED",
        schema: &SCHEMA_UPDATE_STAGING_CONFIRMED,
        owner: OWN_UPGRADED,
    },
    IntentEntry {
        tag: 0x0110,
        name: "UPDATE.ROLLBACK_BLOCKED",
        schema: &SCHEMA_UPDATE_ROLLBACK_BLOCKED,
        owner: OWN_UPGRADED,
    },
    IntentEntry {
        tag: 0x0111,
        name: "UPDATE.ROLLBACK_TO_PREVIOUS_SLOT",
    ...
    IntentEntry {
        tag: 0x0120,
        name: "ATTEST.RECORD_SIGNED",
        schema: &SCHEMA_ATTEST_RECORD_SIGNED,
        owner: OWN_ATTESTD,
    },
    IntentEntry {
        tag: 0x0121,
        name: "ATTEST.RECORD_VERIFY_FAILED",
    ...
    IntentEntry {
        tag: 0x0130,
        name: "SECURITY.REGISTRY_ENFORCING",
        schema: &SCHEMA_SECURITY_REGISTRY_ENFORCING,
        owner: OWN_KERNEL,
    },
    IntentEntry {
        tag: 0x0131,
        name: "SECURITY.PROVIDER_FAULTED",
        schema: &SCHEMA_SECURITY_PROVIDER_FAULTED,
        owner: OWN_KERNEL,
    },
    IntentEntry {
        tag: 0x0132,
        name: "SECURITY.KEYRING_EPOCH_ADVANCED",
    ...
    IntentEntry {
        tag: 0x0142,
        name: "NET.SXT_CHANNEL_OPENED",
        schema: &SCHEMA_NET_SXT_CHANNEL_OPENED,
        owner: OWN_NETD,
    },
    IntentEntry {
        tag: 0x0143,
        name: "NET.SXT_CHANNEL_CLOSED",
    ...
    IntentEntry {
        tag: 0x0150,
        name: "RECOVERY.ENTERED",
        schema: &SCHEMA_RECOVERY_ENTERED,
        owner: OWN_RECOVERYD,
    },
    IntentEntry {
        tag: 0x0151,
        name: "RECOVERY.EXITED",
    ...
    IntentEntry {
        tag: 0x0170,
        name: "HEALTH.TARGET_REACHED",
        schema: &SCHEMA_HEALTH_TARGET_REACHED,
        owner: OWN_MEASUREDD,
    },
    IntentEntry {
        tag: 0x0171,
        name: "HEALTH.TARGET_FAILED",
...
pub const fn catalog_len() -> usize {
    CATALOG_V1.len()
}
...
mod ownership_tests {
    ...
    fn update_tags_owned_by_upgraded() {
        ...
        for entry in CATALOG_V1
            .iter()
            .filter(|e| e.tag >= 0x0100 && e.tag <= 0x011F)
        {
            assert_eq!(
                entry.owner.crate_name, "fjell-upgraded",
                "Tag 0x{:04X} wrong owner",
                entry.tag
            );
        }
    }
