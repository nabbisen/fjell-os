...
fn li_a7(n: u32) -> [u8; 4] {
    ((n << 20) | 0x00000893).to_le_bytes()
}
fn li_a0(n: u32) -> [u8; 4] {
    ((n << 20) | 0x00000513).to_le_bytes()
}
fn li_a1(n: u32) -> [u8; 4] {
    ((n << 20) | 0x00000593).to_le_bytes()
}
...
pub static USER_TASK_A: &[u8] = &[
    // li a0, 0
    0x13, 0x05, 0x00, 0x00, // li a1, 1 (tag: label=1, words=0, caps=0)
    0x93, 0x05, 0x10, 0x00,
    // li a7, 22  (IpcCall) — 22<<20 = 0x1600000; |0x893 = 0x01600893
    0x93, 0x08, 0x60, 0x01, // ecall
    0x73, 0x00, 0x00, 0x00, // li a0, 0
    0x13, 0x05, 0x00, 0x00, // li a7, 1  (Exit)
    0x93, 0x08, 0x10, 0x00, // ecall
    0x73, 0x00, 0x00, 0x00, // wfi
    0x73, 0x00, 0x50, 0x10,
];
...
pub static USER_TASK_C: &[u8] = &[
    ...
    0x13, 0x05, 0x00, 0x00, // li a1, 1  (tag)
    0x93, 0x05, 0x10, 0x00, // li a7, 22  (IpcCall)
    0x93, 0x08, 0x60, 0x01, // ecall  (returns error in a0; task ignores it and exits)
    0x73, 0x00, 0x00, 0x00, // li a0, 0  (exit code = 0)
    0x13, 0x05, 0x00, 0x00, // li a7, 1  (Exit)
    0x93, 0x08, 0x10, 0x00, // ecall
    0x73, 0x00, 0x00, 0x00, // wfi
    0x73, 0x00, 0x50, 0x10,
...
pub static USER_TASK_B: &[u8] = &[
    ...
    0x93, 0x08, 0x50, 0x01, // ecall
    0x73, 0x00, 0x00, 0x00, // li a0, 0  (reply tag)
    0x13, 0x05, 0x00, 0x00,
    // li a7, 23  (IpcReply) — 23<<20 = 0x1700000; |0x893 = 0x01700893
    0x93, 0x08, 0x70, 0x01, // ecall
    0x73, 0x00, 0x00, 0x00, // li a0, 0  (exit code)
    0x13, 0x05, 0x00, 0x00, // li a7, 1  (Exit)
    0x93, 0x08, 0x10, 0x00, // ecall
    0x73, 0x00, 0x00, 0x00, // wfi
    0x73, 0x00, 0x50, 0x10,
