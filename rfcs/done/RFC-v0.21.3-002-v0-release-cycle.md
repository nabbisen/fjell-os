...
**Touches.** `docs/src/releasing/release-checklist.md`, `CHANGELOG.md`, tag
...
`docs/src/releasing/release-checklist.md` is genuinely rigorous — pre-flight
...
Within this RFC's scope, in `docs/src/releasing/release-checklist.md`:
...
- [ ] This cycle is documented at `docs/src/releasing/v0-release-cycle.md` and
      linked from `SUMMARY.md`.
- [ ] `docs/src/releasing/release-checklist.md` steps 6 and 12 invoke real
