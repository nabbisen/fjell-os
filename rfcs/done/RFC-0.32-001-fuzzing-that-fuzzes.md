...
**Status:** Implemented (0.32.0) — accepted 2026-09-15
**Milestone:** 0.32
...
`docs/src/releasing/v0-release-cycle.md` and `docs/src/releasing/release-handoff.md`
(exit criterion 9), `docs/src/adr/ADR-v0.6-003-format-fuzzing.md`,
`docs/src/releasing/v1-readiness.md`. **Does not touch kernel, ABI or service
source.**
