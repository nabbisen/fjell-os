...
| v0.15-003 | Release Checklist and Security Advisory Process | `docs/src/releasing/release-checklist.md` + advisory policy |
| v0.15-004 | Operator Recovery Guide and Field Documentation | `docs/src/operations/recovery-guide.md` |
| v0.15-005 | v1.0 Non-Goals and Constraint Lock | `docs/src/releasing/v1-non-goals.md` |
...
4. `docs/src/releasing/release-checklist.md` produces a reproducible release
...
6. The recovery guide from v0.15-004 covers every entry in v0.13-005's
   DR table.
7. `docs/src/releasing/v1-non-goals.md` is committed and survives an
