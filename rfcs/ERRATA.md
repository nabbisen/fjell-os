...
- **Resolution:** **CLOSED** by RFC-v0.16-003 — a QEMU recovery drill
  ...
  `docs/src/operations/recovery-drills/`.
...
- **Resolution:** **ACCEPTED** (architect, 2026-08-03). Recorded, not fixed.
  ...
  See `docs/src/assurance/instrument-audit-closeout.md` §3.3.
...
>
> 8+4+2+4+3+1 = **22**, matching the summary table exactly. `docs/src/assurance/
...
- **The property itself holds**, checked by hand on 2026-08-31:
  `docs/src/security/threat-model-v1.md` carries 20 `### Tn` sections, every one
...
- **Claim:** `docs/src/security/threat-model-v1.md` §T20
...
- **Restored 2026-09-09**, at the owner's direction, after the removal was found
  ...
  versions — changing **24** of the 29 committed prebuilt binaries and turning
...
- **The channel still floats within `1.91.x`.** Restoring verbatim kept that
  ...
  > evidence that the full build succeeds there: it rebuilt the prebuilts
  > without a compile error.
  >
  > *Figure corrected 2026-09-12, while writing RFC-0.31-003's handoff, and
  > **the correction was itself wrong** — re-corrected the same day at that
  > RFC's review. The tree holds **29** prebuilts (verified at `4cebbc4`,
  > `0.29.0` and `0.30.0`; the repro baseline has 29 entries), and this
  > entry's original **24** was not a miscount of that total: it was the
  > number that **changed**. RFC-0.31-003 measured the identical
  > 1.91.1 → 1.98.1 transition and found exactly 24 of 29 moved, the five
  > unchanged being 32–54 byte stubs. Total and changed-set are different
  > quantities, and the morning's correction made one replace the other
  > everywhere it appeared. The implementer caught it by measuring rather
  > than inheriting the figure.*
  >
  ...
  > tier has run against a 1.98.1-built kernel, and the committed
...
- **Resolution:** ~~**ACCEPTED** (architect, 2026-09-08; updated 2026-09-09),
  ...
  **ACCEPTED**, two survivors named, by **RFC-0.30-003**.
  ...
  > **It is twenty-two places, not five:** `.github/workflows/ci.yml` carries
  > the same apt-install-and-symlink block in **17 of its 19 jobs**, and the
...
- **Why nothing saw it — three instruments, one blind spot.**
  1. The instrument audit (`docs/src/assurance/instrument-audit.md`) recorded
...
- **Resolution:** **ACCEPTED** (architect, 2026-09-16), tracked
  **RFC-0.32-003** (scoped 2026-09-16, at the owner's direction to schedule it
  ...
  > `docs/src/assurance/proofs/`'s prose is in scope and becomes
  ...
  > verified here:** `docs/src/assurance/unsafe-inventory.md` is generated
...
- **Tree, observed 2026-09-16:**
  1. **Neither artefact exists.** `docs/src/security/` holds two files
...
its member findings explicitly; `docs/src/assurance/instrument-audit.md` remains
the authoritative row-level record and
`docs/src/assurance/instrument-audit-closeout.md` the disposition. All three are
